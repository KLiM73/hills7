...
function my_meta_box() {  
    add_meta_box(  
        ...
        'Автор и фотограф', // Заголовок области с мета-полями(title)
...
$meta_fields = array(  
    array(  
        'label' => 'Автор',  
        'desc'  => 'Указание автора статьи под миниатюрой.',  
        'id'    => 'author', // даем идентификатор.
        'type'  => 'text'  // Указываем тип поля.
    ),
    array(  
        'label' => 'Фотограф',  
        'desc'  => 'Указание фотографа под миниатюрой.',  
        'id'    => 'photograph', // даем идентификатор.
        'type'  => 'text'  // Указываем тип поля.
    )  
);
